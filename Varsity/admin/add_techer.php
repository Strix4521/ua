        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" action="add_techer.php" method="post" enctype="multipart/form-data">
    ...
    $description=$_POST['description'];
     ...
     echo $image;
          ...
          if($image['type'] == 'image/jpg' || $image['type'] == 'image/jpeg' || $image['type'] == 'image/png' && $image['size'] < 1024*1024){
            ...
            $sql = "INSERT INTO  teachers (name, qualification,image,description) VALUES ('$name','$qualification','$newimg','$description')";
